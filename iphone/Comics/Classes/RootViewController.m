...
-(void)initComicsArray {
	...
	[self addComicWithJSON:[[NSBundle mainBundle] pathForResource:@"sandraandwoo" ofType:@"json"]];
	...
	[self addComicWithJSON:[[NSBundle mainBundle] pathForResource:@"supernormalstep" ofType:@"json"]];
	[self addComicWithJSON:[[NSBundle mainBundle] pathForResource:@"thebeastlegion" ofType:@"json"]];
	...
	[self addComicWithJSON:[[NSBundle mainBundle] pathForResource:@"wapsisquare" ofType:@"json"]];
