...
public class PreviewURLFactory {
	...
	private static HttpUriRequest createHttpRequest(String searchTerms) {
		String url = "http://ax.search.itunes.apple.com/WebObjects/MZSearch.woa/wa/search?submit=edit&term=" + URLEncoder.encode(searchTerms);
