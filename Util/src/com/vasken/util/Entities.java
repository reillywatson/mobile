...
class Entities {
    ...
    // Entities that we don't escape for reasons unknown
    public static final Entities SHORTCOVER;
    ...
    static {
    	SHORTCOVER = new Entities();
    	SHORTCOVER.addEntities(HTML40_ARRAY);
    }
    ...
    static class PrimitiveEntityMap implements EntityMap {
        private HashMap<String, Integer> mapNameToValue = new HashMap<String, Integer>();
    ...
    static abstract class MapIntMap implements Entities.EntityMap {
        protected HashMap<String, Integer> mapNameToValue;

        protected HashMap<Integer, String> mapValueToName;
